...
class categoryService 
{
	...
	public static function show($fid = 0, $style="option", $level = 0 , $str='')
	{
		...
		if(!empty($categorys))
		{
			...
			foreach($categorys as $k => $category)
			{
				...
				{
					case "option":
						$str = self::option_sytle($category, $level, $str);
						break;
					case "tr":
						$str = self::tr_sytle($category, $level, $str);
						break;
				}
				$str = self::show($category->id, $style, $level, $str);
	...
	public static function option_sytle($category,$level, $str)
	{
			$g="";
			$str .= "<option style=\"";
